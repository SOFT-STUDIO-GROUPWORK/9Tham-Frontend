  ...
  return (
    <div className="flex flex-1">
      <input
        ...
        placeholder="ค้นหา..."
      />
      <button onClick={props.onClick} className="btn px-6 py-3 bg-amber-500 text-white font-medium text-xs leading-tight uppercase rounded shadow-sm hover:bg-amber-600 hover:shadow-lg focus:bg-amber-600  focus:shadow-lg focus:outline-none focus:ring-0 active:bg-amber-700 active:shadow-lg transition duration-150 ease-in-out ">
        <FaSearch />
      </button>
    </div>
  );
